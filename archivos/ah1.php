...
mysql_select_db("add",$conect) or die ("problemas EN la seleccion EN la base de datos");
$result2a=mysql_query ("SELECT * FROM usr WHERE i2 = '$usuario' and i3 = '$clave' and i4 = '$asao' ORDER BY id ASC",$conect)or die ("EL Numero de deposito o referencia no se encuentra");
