...
{ $tramite="60 dias"; /* Habilitado */ }
if ($variable==$habiltar2)
{ $tramite="120 dias"; /* Habilitado */}
?>
...
Titulos (Fondo Negro) Certificados</td><td><select name=v3<?php echo $legolas;?> id="v3" required disabled><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option></select></td>
...
Otros</td><td><select name=v5<?php echo $legolas;?> id="v5" required disabled><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option></select></td>
