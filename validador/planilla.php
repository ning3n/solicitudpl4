...
<tr>
<td>
<IMG SRC=LogoULA.jpg WIDTH=75 HEIGHT=80 align=left></td>
<td>
...
$ini="INSERT INTO data (saldo,tipoc,cedula,dia,mes,ao,telefono,apellido,nombre,diag,mesg,aog,facultad,escuela,titulo,notas,variable,globalesL,aprobatoriasL,titulosL,actaL,otrosL,globalesN,aprobatoriasN,titulosN,actaN,otrosN,email,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,user_id,resta,referencia,cod2)VALUES('$saldo','$tipoc','$cedula','$dia','$mes','$ao','$telefono','$apellido','$nombre','$diag','$mesg','$aog','$facultad','$escuela','$titulo','$notas','$variable','$globalesL','$aprobatoriasL','$titulosL','$actaL','$otrosL','$globalesN','$aprobatoriasN','$titulosN','$actaN','$otrosN','$email','$v1','$v2','$v3','$v4','$v5','$v6','$v7','$v8','$v9','$v10','$user_id','$resta','$numerolod2','$numerolod')";
...
echo $saldo;?><font size=2>BsF</u></td>
...
<tr>
<td colspan=2 style="border: hidden"><center><input type='button' name='imprimir' value='Imprimir' onclick='window.print();'></form></td><td style="border: hidden"><form action=index.php><input type=submit value=Salir></form></td>
</tr>
